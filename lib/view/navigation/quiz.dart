...
class _QuizScreenState extends State<QuizScreen> {
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              Container(
                color: colorPallets[Random().nextInt(colorPallets.length)],
                child: Padding(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      border: Border.all(
                                          ...
                                          width: 1),
                                      color: widget.catgoryType != "G.K. Round"
                                          ? clickedButtonIndex == index
                                              ? bgColor
                                              : whiteBg
                                          : whiteBg,
                                  ...
                                  child: Center(
                                      child: widget.catgoryType == "G.K. Round"
                                          ? TextField(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              ...
                              final int totalScore =
                                  widget.question.length * 10;
                              print("scoreAchieved: $_score");
                              print("totalScore: $totalScore");

                              // pass
                              if (_score >= (totalScore/1.2)) {
                                status = "excellent";
                              }

                              // fail
                              else if (_score < (totalScore/1.2) && _score >= (totalScore/2)) {
                                status = "medium";
                              }
                                ...
                                child: ElevatedButton(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Lottie.asset('assets/icons/next.json',
                                          height: 32)
                                    ],
                                  ),
                                )),
  ...
  Future<dynamic> _exitDialogMethod(BuildContext context) {
    return showDialog(
